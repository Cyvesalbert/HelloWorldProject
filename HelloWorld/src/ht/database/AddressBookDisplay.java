...
public class AddressBookDisplay extends JFrame{
	...
	public AddressBookDisplay() {
		...
		// establish database connection and set up prepared statement
		...
		previousButton.addActionListener(
				new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
						previousButtonAtionPerformed(evt);
					}
				}
				);
		...
		addWindowListener(
				new WindowAdapter() {
					public void windowClosing(WindowEvent evt) {
						personQueries.close(); // close DB connection
						System.exit(0);
					}
				}
				);
	...
	// handle call when nextbutton is clicked
	private void nextButtonAtionPerformed(ActionEvent evt) {
		currentEntryIndex++;
	...
	// handle call when previousbutton is clicked
	private void previousButtonAtionPerformed(ActionEvent evt) {
		currentEntryIndex--;
	...
	// handle call when queryButton is clicked
	private void queryButtonActionPerformed(ActionEvent evt) {
		...
		if ( numberOfEntries != 0 ){
			...
			lastNameTextField.setText( currentEntry.getLastame() );
	...
	// handle call when browseButton is clicked
	...
	// handle call when inseretbutton is clicked
