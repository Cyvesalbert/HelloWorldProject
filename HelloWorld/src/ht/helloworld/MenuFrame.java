...
public class MenuFrame extends JFrame {
	...
	private JLabel displayJLabel; // display sample text
	...
	public MenuFrame() {
		...
		aboutItem.addActionListener(
				new ActionListener() { // anonymous inner class
					...
					public void actionPerformed(ActionEvent event) {
						JOptionPane.showMessageDialog(MenuFrame.this, "This is an exemple\nof using menus", "About", JOptionPane.PLAIN_MESSAGE);
					}
				}
				);
		...
		bar.add(fileMenu); // add menu bar to application
