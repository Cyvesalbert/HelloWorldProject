...
public class MergeSort {
	...
	// calls recursively split method to  begin merge sorting
	public void sort() {
		sortArray(0, data.length - 1);
	}
	
	// splits array, sorts subarrays and merge subarrays into sorted array
	...
	// merge two sorted subarrays into one sorted subarrays
