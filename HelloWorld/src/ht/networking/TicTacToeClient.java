...
public class TicTacToeClient extends JFrame implements Runnable{
	...
	private boolean myTurn; // determiones which client's turn it is 
	...
	public TicTacToeClient(String host) {
		...
		panel2.add(boardPanel, BorderLayout.CENTER); // add boardPanel
	...
	// control thread that allows continuous update of display area
	public void run() {
		...
		myTurn = (myMark.equals(X_MARK)); // determine if clients turn
